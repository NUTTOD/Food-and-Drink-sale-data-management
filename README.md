...
2.  ใน Command Prompt หรือ Terminal เดียวกัน ให้ใช้คำสั่งต่อไปนี้เพื่อรันโปรแกรม:
    ...
    ```
### 🧪 การใช้งาน Unit Test (End-to-end Test)

    สามารถใช้งานในโปรแกรมได้เลย

### 🧪 การใช้งาน E2E Test (End-to-end Test)

#### สิ่งที่ต้องมีในการ Test

1. ไฟล์ที่ต้องมีในการเทศ
...
2. การเทส
    ...
    เปิดใช้งาน `run_e2e_test.bat` เพื่อทำการทดสอบ และผลจะทำการบันทึกใน `output.log` หลังจากการเทส

3. ข้อควรระวัง

    **🚨⚠️ต้องปิดการใช้งานโปรแกรมก่อนทำการใช้งาน E22 Test⚠️🚨**
